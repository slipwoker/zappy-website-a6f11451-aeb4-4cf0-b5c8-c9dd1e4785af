    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "סע\"ר הרצליה צפון משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a6f11451-aeb4-4cf0-b5c8-c9dd1e4785af',
                    name: data.name || '',
                    email: data.email || '',
